...
<h3>Eatstreet</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Explore texture ,color and  ofcourse the ultimate tastes with our menu.Enjoy an extaordinary experience</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(254) 0768882403 <br>(254) 0757951840</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">Eatstreet@gmail.com</a></span>
                </div>
            </li>
